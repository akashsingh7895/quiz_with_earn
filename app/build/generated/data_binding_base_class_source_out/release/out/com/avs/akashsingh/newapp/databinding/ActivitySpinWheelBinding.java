...
public final class ActivitySpinWheelBinding implements ViewBinding {
  ...
  private ActivitySpinWheelBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView backButton, @NonNull LinearLayout bannerContainer,
      @NonNull TextView spinAvail, @NonNull ImageView spinBtn, @NonNull ImageView spinPin,
      @NonNull ImageView spinWheel, @NonNull TextView texttool, @NonNull Toolbar toolbar,
      @NonNull TextView totalSpin, @NonNull View view) {
  ...
  public static ActivitySpinWheelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySpinWheelBinding((ConstraintLayout) rootView, backButton, bannerContainer,
          spinAvail, spinBtn, spinPin, spinWheel, texttool, toolbar, totalSpin, view);
    }
